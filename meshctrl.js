...
function serverConnect() {
    ...
    ws.on('open', function open() {
        ...
        switch (settings.cmd) {
            ...
            case 'devicemessage': {
                ws.send(JSON.stringify({ action: 'msg', type: 'messagebox', nodeid: args.id, title: args.title ? args.title : "Remote Control", msg: args.msg, responseid: 'meshctrl' }));
                break;
            }
            case 'devicetoast': {
                ws.send(JSON.stringify({ action: 'toast', nodeids: [args.id], title: args.title ? args.title : "Remote Control", msg: args.msg, responseid: 'meshctrl' }));
                break;
            }
        }
    });
